...
public class RegistrationView extends FragmentActivity implements
...
////    recipeDialogFragment.show(fragmentManager, "recipeDialogFragment");
    ...
    if (pm.hasSystemFeature(PackageManager.FEATURE_CAMERA_FRONT)) {
      ...
      cameraViewDialog.setRegistrationView(this);
...
//    }
  ...
  public void showBackButton() {
    ...
    backButton.setImageResource(R.drawable.peer_back);
