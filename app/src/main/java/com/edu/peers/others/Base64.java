 ...
 * support for specifying a class loader when using the {@link #decodeToObject(String, int,
 * ClassLoader)} method.</li> <li>v2.3.3 - Changed default char encoding to US-ASCII which reduces
 * the internal Java footprint with its CharEncoders and so forth. Fixed some javadocs that were
 * inconsistent. Removed imports and specified things like java.io.IOException explicitly
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
   ...
   * a null value, but in retrospect that's a pretty poor way to handle it.</p>
   *
  ...
  public static String encodeBytes(byte[] source) {
    ...
    // we should not force the accessCredential to have to catch it.
    String encoded = null;
    try {
   ...
   * myData, Base64.GZIP | Base64.DO_BREAK_LINES )</code>
   *
   *
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
   ...
   * encoding. <p>This is the lowest level of the decoding methods with all possible
   * parameters.</p>
   *
   * @param source      the array to convert
   * @param srcOffset   the index where conversion begins
...
//        }
  ...
  public static String encodeFromFile(String filename)
    ...
    try {
      ...
      byte[]
          buffer =
          new byte[Math.max((int) (file.length() * 1.4 + 1),
  ...
  public static class InputStream extends java.io.FilterInputStream {
    ...
    /**
     * Constructs a {@link Base64.InputStream} in either ENCODE
     * or DECODE mode. <p>
     * Valid options:<pre>
  ...
  public static class OutputStream extends java.io.FilterOutputStream {
    ...
    /**
     * Constructs a {@link Base64.OutputStream} in ENCODE
     * mode.
     *
    ...
    /**
     * Constructs a {@link Base64.OutputStream} in either
     * ENCODE or DECODE mode. <p>
     * Valid options:<pre>
     *   ENCODE or DECODE: Encode or Decode as data is read.
