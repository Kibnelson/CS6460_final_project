 ...
 */
public abstract class SimpleExpandableListAdapterContentFile extends BaseExpandableListAdapter implements OnDataChangeListener   {
  ...
  public SimpleExpandableListAdapterContentFile(Context context,
                                                List<? extends Map<String, Content>> groupData, int groupLayout,
  ...
  public SimpleExpandableListAdapterContentFile(Context context,
                                                List<? extends Map<String, Content>> groupData, int expandedGroupLayout,
  ...
  private void bindGroupView(View view, Map<String, Content> data, String[] from, int[] to) {
    int len = to.length;

    for (int i = 0; i < len; i++) {
      TextView v = (TextView)view.findViewById(to[i]);
      if (v != null) {
        v.setText(data.get(from[i]).getTitle());
      }
    }
  }

  private void bindChildView(View view, Map<String, ContentFile> data, String[] from, int[] to) {
    int len = to.length;
