...
import com.edu.peers.views.GradebookQuizListView;

import java.util.List;


public class GradebookListViewAdapter extends BaseAdapter {

  private final GradebookQuizListView mContext;

  private final List<Quiz> items;

  public GradebookListViewAdapter(GradebookQuizListView c,
                                  List<Quiz> items) {
    mContext = c;
    this.items = items;
  }
